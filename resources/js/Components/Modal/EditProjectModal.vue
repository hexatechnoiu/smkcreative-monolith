                                ...
                                <div class="grid gap-4 mt-2">
                                    ...
                                    <div>
                                        ...
                                        <select
                                            name="category"
                                            id="category"
                                            v-model="tempProject.category.id"
                                            class="bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-200 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5"
                                        >
                                            <option
                                    ...
                                    <div>
                                        ...
                                        >
                                        <img
                                            v-if="tempProject.photoPreview"
                                            :src="tempProject.photoPreview"
                                            class="rounded-lg mb-2 max-h-40 object-cover"
                                            alt="Project Preview"
                                        />
                                        <input
                                            type="file"
