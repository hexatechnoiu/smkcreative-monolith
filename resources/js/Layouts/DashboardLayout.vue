...
<template>
    ...
    <button data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar"
        type="button" @click.prevent="sidebar_shown = !sidebar_shown"
    ...
    <aside id="default-sidebar"
        :class="'fixed top-0 left-0 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 ' + (sidebar_shown ? 'translate-x-0' : '')"
        aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Project Dashboard</span>
                    </Link>
                </li>
