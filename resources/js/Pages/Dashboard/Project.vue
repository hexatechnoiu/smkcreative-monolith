  ...
  <DashboardLayout>
    <div>
      <div class="flex text-primary justify-start p-1">
        <button @click="createModalOpen = true" class="rounded-full hover:bg-gray-300 flex py-2 px-4 gap-1 group transition-opacity duration-200">
            ...
            <div class="flex flex-col space-y-1.5 p-2">
              <div style="position: relative; width: 100%; padding-bottom: 60%">
                <div style="position: absolute; inset: 0px">
                  <img alt="Profile company web NOIU" loading="lazy" decoding="async" class="rounded-md object-cover"
