...
<template>
    ...
    <DashboardLayout>
                    ...
                    >
                        ...
                        <div class="flex justify-between">
                            <div class="p-6 pt-0">
                                ...
                                <p
                                    class="text-sm text-muted-foreground dark:text-violet-200"
                                >
                            ...
                            <Menu
                                as="div"
                                class="relative inline-block text-left px-3"
                            >
                                <div>
                                    <MenuButton
                                    ...
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            class="min-w-[24px] aspect-square"
                                            viewBox="0 -960 960 960"
                                            fill="currentColor"
                                        >
                                            <path
                                ...
                                >
                                    <MenuItems
                                        class="absolute z-10 right-0 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white dark:bg-indigo-950 shadow-lg ring-1 ring-black/5 focus:outline-none"
                                    >
                                        <div class="px-1 py-1">
        ...
        <EditProjectModal
            ...
            :project="sp"
            @toggle-modal="(value) => (updateModalOpen = value)"
            :categories
        />
        <DeleteProjectModal
            ...
            :project="sp"
            @toggle-modal="(value) => (deleteModalOpen = value)"
            :categories
        />
        <CreateProjectModal
            v-if="createModalOpen"
            :isOpen="createModalOpen"
            @toggle-modal="(value) => (createModalOpen = value)"
            :categories
        />
    </DashboardLayout>
</template>
