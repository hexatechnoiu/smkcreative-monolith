                        ...
                        <ul class="space-y-4 pt-8">
                            ...
                            <li>
                                <a
                                    ...
                                    >Website Teaching Factory (Lama)</a
                                >
                            </li>
                            <li>
                                <a
                                    class="transition-all hover:opacity-50"
                                    href="https://masjid.smkn2sumedang.sch.id/"
                                    >Masjid Baiturrahim</a
                                >
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="space-y-4 pt-8">
                            ...
                            <li>
                                <a
                                    class="transition-all hover:opacity-50"
                                    href="email:smkn2sumedang@yahoo.com"
                            ...
                            <li>
                                <a
                                    class="transition-all hover:opacity-50"
                                    href="https://maps.app.goo.gl/XkKuMqAxmBYEofe68"
                                    >Jl. Arief Rakhman Hakim No. 59, Sumedang</a
                                >
                            </li>
                        </ul>
                    </li>
