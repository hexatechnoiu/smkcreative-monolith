<template>
    <footer class="relative inset-x-0 bottom-0 mt-12 bg-primary text-white">
        <div class="grid gap-12 px-8 pt-24 lg:container lg:grid-cols-3 lg:gap-24">
            <div aria-labelledby="footer-header">
                <div class="flex items-center gap-4">
                    <img alt="Rekayasa Perangkat Lunak" loading="eager" width="52" height="52" decoding="async"
                        data-nimg="1" style="color: transparent" src="/assets/images/logo-rpl.png" />
                ...
                <ul class="grid grid-cols-2 gap-12 lg:grid-cols-3">
                    <li>
                        ...
                        <ul class="space-y-4 pt-8">
                            <li>
                                <a class="transition-all hover:opacity-50" href="#hero">Beranda</a>
                            </li>
                            <li>
                                <a class="transition-all hover:opacity-50" href="#about">Tentang Kami</a>
                            </li>
                            <li>
                                <a class="transition-all hover:opacity-50" href="#project">Projects</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="space-y-4 pt-8">
                            <li>
                                <a class="transition-all hover:opacity-50" href="https://smkn2sumedang.sch.id/">Website
                                    SMKN 2 Sumedang</a>
                            </li>
                            <li>
                                <a class="transition-all hover:opacity-50"
                                    href="https://tefa.smkn2sumedang.sch.id/">Website Teaching Factory (Lama)</a>
                            </li>
                            <li>
                                <a class="transition-all hover:opacity-50"
                                    href="https://masjid.smkn2sumedang.sch.id/">Masjid Baiturrahim</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="space-y-4 pt-8">
                            <li>
                                <a class="transition-all hover:opacity-50" href="tel:0261201531">0261-201531</a>
                            </li>
                            <li>
                                <a class="transition-all hover:opacity-50"
                                    href="email:smkn2sumedang@yahoo.com">smkn2sumedang@yahoo.com</a>
                            </li>
                            <li>
                                <a class="transition-all hover:opacity-50"
                                    href="https://maps.app.goo.gl/XkKuMqAxmBYEofe68">Jl. Arief Rakhman Hakim No. 59,
                                    Sumedang</a>
                            </li>
                        </ul>
                    </li>
        ...
        <div aria-labelledby="footer-sosials">
            <div class="flex px-8 py-8 md:container">
                <div class="flex gap-6">
                    <a href="https://www.instagram.com/rpl.pplg_smkn2sumedang/"><svg width="24" height="25"
                        ...
                        </svg></a><a href="https://www.youtube.com/channel/UCxYVJELGTUCXsh1eIC4YzwA"><svg width="24"
                            height="25" viewBox="0 0 24 25" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        </svg></a><a href="https://www.tiktok.com/@smkn2sumedang.official">
                ...
                <div class="ml-4 border-l pl-4">
                    ©<!-- -->
                    <a class="transition-all hover:opacity-50" href="https://smkn2sumedang.sch.id/">PPLG SMKN 2 SUMEDANG</a>
                </div>
            </div>
        </div>
    </footer>
